...
- **WiFi IP Address**: `192.168.137.173`
- **Backend API**: `http://192.168.137.173:8000`
- **Frontend App**: `http://192.168.137.173:5173`
...
<!-- After -->
<link rel="preconnect" href="http://192.168.137.173:8000" />
```
...
4. Open `http://192.168.137.173:5173` on any device
...
- Try accessing from your PC first: `http://192.168.137.173:5173`
...
- Test backend directly: `http://192.168.137.173:8000`
...
- Frontend: `http://localhost:5173` OR `http://192.168.137.173:5173`
- Backend: `http://localhost:8000` OR `http://192.168.137.173:8000`

### From Other Devices (Same WiFi):

- Frontend: `http://192.168.137.173:5173`
- Backend: `http://192.168.137.173:8000`
...
4. On mobile: Open `http://192.168.137.173:5173`
...
- Frontend: Look for "Local: http://localhost:5173" and "Network: http://192.168.137.173:5173"
...
2. ✅ Open app on mobile: `http://192.168.137.173:5173`
